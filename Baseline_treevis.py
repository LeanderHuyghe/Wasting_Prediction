...
your_datapath = '/Users/MoshaLangerak_1/Documents/GitHub/Wasting_Prediction/data/'
...
visualise_tree_path = '/Users/MoshaLangerak_1/Desktop/treevisualisation/'
...
if cross_validation:
    ...
    best_model_trees = 74
    best_model_depth = 6
    best_model_columns = ['district_encoded']
...
if visualise_tree_path != '':
    import matplotlib.pyplot as plt
    from sklearn.tree import plot_tree

    for i in range(0, best_model_trees):
        fig = plt.figure(figsize=(15, 10))
        plot_tree(clf.estimators_[i], 
                filled=True, impurity=True, 
                rounded=True)
        fig.savefig('%stree_%s.png'%(visualise_tree_path, i))
        plt.close(fig)